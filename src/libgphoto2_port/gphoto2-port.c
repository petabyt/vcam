...
#define CHECK_SUPP(p, t, o)                                                                                   \
	{                                                                                                     \
		if (!(o)) {                                                                                   \
			gp_port_set_error((p), _("The operation '%s' is not supported by this device"), (t)); \
...
#define CHECK_INIT(p)                                                                       \
	{                                                                                   \
		if (!(p)->pc->ops) {                                                        \
			gp_port_set_error((p), _("The port has not yet been initialized")); \
 ...
 * \return a gphoto2 error code
 */
int gp_port_usb_msg_write(GPPort *port, int request, int value, int index,
			  char *bytes, int size) {
	int retval;
 ...
 * \return a gphoto2 error code
 */
int gp_port_usb_msg_read(GPPort *port, int request, int value, int index,
			 char *bytes, int size) {
	int retval;
 ...
 * \return a gphoto2 error code
 */
int gp_port_usb_msg_interface_read(GPPort *port, int request, int value, int index,
				   char *bytes, int size) {
	int retval;
 ...
 * \return a gphoto2 error code
 */
int gp_port_usb_msg_class_read(GPPort *port, int request, int value, int index,
			       char *bytes, int size) {
	int retval;
