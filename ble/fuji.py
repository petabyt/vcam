...
# https://github.com/hadess/bluez/blob/master/test/example-gatt-server#L143
...
class FujiAdvertisement(Advertisement):
    def __init__(self, bus, index):
        Advertisement.__init__(self, bus, index, 'peripheral')
        self.add_service_uuid('117c4142-edd4-4c77-8696-dd18eebb770a')
        self.add_manufacturer_data(0x04D8, [0x02, 0x14, 0xA3, 0x20, 0x80])
        self.add_local_name('CA2AX-H1')
        self.include_tx_power = False
...
def main(timeout=0):
    ...
    test_advertisement = FujiAdvertisement(bus, 0)
